...
routuer.get('/v1/hello', (req,res) => {
    if (req.header["token"] == "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c")
        {res.json({"message": "new_message"})}
    else {
        res.status("400").send("INCORRECT TOKEN")
